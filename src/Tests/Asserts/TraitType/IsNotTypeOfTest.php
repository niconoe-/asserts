...
final class IsNotTypeOfTest extends TestCase
{
    ...
    public function setUp()
    {
        $this->testClass = new class()
        {
            ...
            {
                return static::assertIsNotTypeOf(['string'], true, new Exception('This assertion fails.'));
            }
            ...
            {
                return static::assertIsNotTypeOf(['string'], 'Yes string', new Exception('This assertion fails.'));
            }
        };
    }
