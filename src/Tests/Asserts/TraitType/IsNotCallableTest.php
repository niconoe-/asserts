...
final class IsNotCallableTest extends TestCase
{
    ...
    public function setUp()
    {
        $this->testClass = new class()
        {
            ...
            {
                return static::assertIsNotCallable(true, new Exception('This assertion fails.'));
            }
            ...
            public function runKo(): bool
            {
                ...
                return static::assertIsNotCallable($callback, new Exception('This assertion fails.'));
            }
        };
    }
