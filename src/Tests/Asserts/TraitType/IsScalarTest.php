...
final class IsScalarTest extends TestCase
{
    ...
    public function setUp()
    {
        $this->testClass = new class()
        {
            ...
            {
                return static::assertIsScalar('I am scalar', new Exception('This assertion fails.'));
            }
            ...
            {
                return static::assertIsScalar(['I am not scalar'], new Exception('This assertion fails.'));
            }
        };
    }
