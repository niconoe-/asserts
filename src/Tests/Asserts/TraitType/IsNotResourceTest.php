...
final class IsNotResourceTest extends TestCase
{
    ...
    public function setUp()
    {
        $this->testClass = new class()
        {
            ...
            {
                return static::assertIsNotResource(true, new Exception('This assertion fails.'));
            }
            ...
            {
                return static::assertIsNotResource($this->resource, new Exception('This assertion fails.'));
            }
        };
    }
