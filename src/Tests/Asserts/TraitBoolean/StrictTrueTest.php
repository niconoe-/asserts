 ...
 * @license MIT
 */
final class StrictTrueTest extends TestCase
{
    /**
    ...
    public function setUp()
    {
        $this->testClass = new class()
        {
            ...
            {
                return static::assertStrictTrue(true, new Exception('This assertion fails.'));
            }
            ...
            {
                return static::assertStrictTrue(1, new Exception('This assertion fails.'));
            }
        };
    }
