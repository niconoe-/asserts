...
final class CountRecursiveTest extends TestCase
{
    ...
    public function setUp()
    {
        $this->testClass = new class()
        {
            ...
            {
                $provider = [[1], [2], [3], [4], [5]];
                return static::assertCountRecursive($provider, 10, new Exception('This assertion fails.'));
            }
            ...
            {
                $provider = [[1], [2], [3], [4], [5]];
                return static::assertCountRecursive($provider, 5, new Exception('This assertion fails.'));
            }
        };
    }
