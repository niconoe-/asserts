...
trait AssertObjectTrait
{
     ...
     */
    public static function assertObjectIsA($object, string $type, Throwable $exception)
    {
     ...
     */
    public static function assertPropertiesInCascade($object, Throwable $exception, string ...$propertiesInCascade)
    {
